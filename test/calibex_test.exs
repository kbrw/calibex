defmodule CalibexTest do
  ...
  test "ical encoding" do
    res = Calibex.encode(vcalendar: [[
        ...
        vevent: [[
          ...
          attendee: [cutype: "INDIVIDUAL",role: "REQ-PARTICIPANT",partstat: "NEEDS-ACTION",rsvp: true, cn: "arnaudwetzel@examp.com",
                      "x-num-guests": 0, value: "mailto:arnaudwetzel@examp.com"],
          attendee: [cutype: "INDIVIDUAL",role: "REQ-PARTICIPANT",partstat: "ACCEPTED",rsvp: true, cn: "Arnaud Wetzel",
                      x_num_guests: 0, value: "mailto:arnaud.wetzel@example.com"],
  ...
  test "ical helpers" do
   ...
   vevent: [[uid: _,
     ...
     organizer: [cn: "arnaud.wetzel@example.com",
     ...
     attendee: [cutype: "INDIVIDUAL", role: "REQ-PARTICIPANT",
      ...
      cn: "jeanpierre@yahoo.fr", value: "mailto:jeanpierre@yahoo.fr"],
     attendee: [cutype: "INDIVIDUAL", role: "REQ-PARTICIPANT",
      partstat: "NEEDS-ACTION", rsvp: true, x_num_guests: 0, cn: "jean@ya.fr",
      value: "mailto:jean@ya.fr"]]]]]] = req
  end
end
